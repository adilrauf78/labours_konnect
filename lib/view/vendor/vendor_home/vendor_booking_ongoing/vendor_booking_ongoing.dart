...
import 'package:labours_konnect/view/vendor/vendor_home/vendor_booking_inprogress/vendor_booking_inprogress.dart';

class VendorBookingOngoing extends StatefulWidget {
  const VendorBookingOngoing({super.key});

  @override
  State<VendorBookingOngoing> createState() => _VendorBookingOngoingState();
}

class _VendorBookingOngoingState extends State<VendorBookingOngoing> {
  double _rating = 5;
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  navigateToNextScreen(context, VendorBookingInprogress());
                },
                child: Container(
                  width: MediaQuery.of(context).size.width,
                  height: 50..h,
