...
class VendorBookingCompleted extends StatefulWidget {
  const VendorBookingCompleted({super.key});

  @override
  State<VendorBookingCompleted> createState() => _VendorBookingCompletedState();
}

class _VendorBookingCompletedState extends State<VendorBookingCompleted> {
  double _rating = 5;
  @override
