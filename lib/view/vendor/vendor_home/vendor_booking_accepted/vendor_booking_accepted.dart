...
class VendorBookingAccepted extends StatefulWidget {
  const VendorBookingAccepted({super.key});

  @override
  State<VendorBookingAccepted> createState() => _VendorBookingAcceptedState();
}
