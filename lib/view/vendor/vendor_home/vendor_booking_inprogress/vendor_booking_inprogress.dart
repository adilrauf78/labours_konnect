...
class VendorBookingInprogress extends StatefulWidget {
  const VendorBookingInprogress({super.key});

  @override
  State<VendorBookingInprogress> createState() => _VendorBookingInprogressState();
}

class _VendorBookingInprogressState extends State<VendorBookingInprogress> {
  double _rating = 5;
  @override
